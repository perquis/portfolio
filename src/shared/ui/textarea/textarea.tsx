  ...
  return (
    <Motion
      animate={
        error
          ? {
              rotate: TRANSITION_ARGS,
              translateX: TRANSITION_ARGS,
            }
          : {
              rotate: 0,
              translateX: 0,
    ...
    >
      <Section className="items-start gap-1">
        ...
        <textarea
          className={clsx(
            "min-h-64 w-full rounded-[10px] bg-zinc-100 px-3 py-2.5 text-sm text-zinc-900 transition-colors duration-200 placeholder:text-zinc-400 hover:bg-zinc-200 focus-visible:bg-zinc-200 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder:text-zinc-600 dark:hover:bg-zinc-800 dark:focus-visible:bg-zinc-800",
